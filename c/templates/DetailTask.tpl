    ...
    <table class="table">
        <tr>
            <td>
                ...
                <button type="button" class="btn btn-default" rel="" data-toggle="tooltip" title="назад" onclick="window.location='/?cmd=getUserTask'"><span class="glyphicon glyphicon-arrow-left"></span></button>
            </td>
        </tr>
    </table>
<?php else: ?>
