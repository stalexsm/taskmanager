...
<div class="col-md-12" id="content">
    ...
    <h3>Ваши задачи ( <?php echo $count; ?> ) </h3>
    <table class="table">
        <tr>
            <th>#</th>
            <th>Проект</th>
        ...
        <tr>
            <td><a href="/?cmd=getUserTask&act=view&id=<?php echo $object['id']; ?>" >#<?php echo $object['id']; ?></a></td>
            <td><a href="/?cmd=getUserTask&act=view&id=<?php echo $object['id']; ?>" ><?php echo $object['title']; ?></a></td>
    ...
    <hr>
    <p>Всего закрепленных задач: <b><?php echo $count; ?></b></p>
<div class="test"></div>
</div>
...
<?php endif; ?>
<?php else: ?>
<h1 class="text-center"> НА ДАННЫЙ МОМЕНТ НЕТ ЗАКРЕПЛЕННЫХ ЗАДАЧ.</h1>
<?php endif; ?>
